...
//Tiempo estimado de vida util de la memoria: 57 años

#define EEPROM_ADDR_WATTHORASCARGA_BAT 1
#define EEPROM_ADDR_WATTHORASDESCARGA_BAT 101
#define EEPROM_ADDR_WATTHORASSALIDA 201
#define EEPROM_ADDR_UPTIME 301
#define EEPROM_ADDR_TOTALTIME 401
#define EEPROM_ADDR_WATTHORASCARGA_ULT_BAT 501
#define EEPROM_ADDR_WATTHORASDESCARGA_ULT_BAT 601
